...
public class BeechSapling extends BushBlock implements IGrowable {
    ...
    public BeechSapling(Supplier<Tree> treeIn, Properties properties) {
        super(properties);
        tree = treeIn;
    }
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        return (state.getBlock() == ModBlock.radioactive_dirt.get());
    }
}
