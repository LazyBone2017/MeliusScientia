...
public class ModItem {
    ...
    public static final RegistryObject<Item> rps_chestplate = ITEMS.register("rps_chestplate", () -> new ArmorItem(ModArmorMaterials.RPS, EquipmentSlotType.CHEST, new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
    public static final RegistryObject<Item> rps_helmet = ITEMS.register("rps_helmet", () -> new ArmorItem(ModArmorMaterials.RPS, EquipmentSlotType.HEAD, new Item.Properties().group(ModItemGroups.MOD_ITEM_GROUP)));
}
